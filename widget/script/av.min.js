! function(e) {
	e.AV = e.AV || {}, e.AV.VERSION = "js0.5.0"
}(this), function() {
	var e = this, t = e._, n = {}, i = Array.prototype, r = Object.prototype, s = Function.prototype, a = i.push, o = i.slice, u = i.concat, c = r.toString, l = r.hasOwnProperty, h = i.forEach, d = i.map, f = i.reduce, p = i.reduceRight, _ = i.filter, m = i.every, v = i.some, g = i.indexOf, b = i.lastIndexOf, y = Array.isArray, w = Object.keys, A = s.bind, O = function(e) {
		return e instanceof O ? e : this instanceof O ?
		void (this._wrapped = e) : new O(e)
	};
	...
	var S = O.each = O.forEach = function(e, t, i) {
		if (null != e)
			if (h && e.forEach === h)
				...
				for (var a in e)
				if (O.has(e, a) && t.call(i, e[a], a, e) === n)
					return
	};
	...
	O.reduce = O.foldl = O.inject = function(e, t, n, i) {
		...
		if (null == e && ( e = []), f && e.reduce === f)
			return i && ( t = O.bind(t, i)), r ? e.reduce(t, n) : e.reduce(t);
		...
		if (null == e && ( e = []), p && e.reduceRight === p)
			return i && ( t = O.bind(t, i)), r ? e.reduceRight(t, n) : e.reduceRight(t);
		var s = e.length;
		if (s !== +s) {
			var a = O.keys(e);
			s = a.length
		...
		return E(e, function(e, r, s) {
			return t.call(n, e, r, s) ? ( i = e, !0) :
			void 0
		}), i
	}, O.filter = O.select = function(e, t, n) {
		var i = [];
		return null == e ? i : _ && e.filter === _ ? e.filter(t, n) : (S(e, function(e, r, s) {
	...
	O.contains = O.include = function(e, t) {
		...
		if (!t && O.isArray(e) && e[0] === +e[0] && e.length < 65535)
	...
	O.groupBy = function(e, t, n) {
		...
		return null == e ?
		void 0 : null == t || n ? e[0] : o.call(e, 0, t)
	}, O.initial = function(e, t, n) {
		return o.call(e, 0, e.length - (null == t || n ? 1 : t))
	}, O.last = function(e, t, n) {
		return null == e ?
		void 0 : null == t || n ? e[e.length - 1] : o.call(e, Math.max(e.length - t, 0))
	...
	var N = function(e, t, n) {
		return S(e, function(e) {
			O.isArray(e) ? t ? a.apply(n, e) : N(e, t, n) : n.push(e)
		}), n
	};
	O.flatten = function(e, t) {
		...
		for (var e = o.call(arguments), t = O.max(O.pluck(e, "length")), n = new Array(t), i = 0; t > i; i++)
			n[i] = O.pluck(e, "" + i);
		return n
		...
		if (n) {
			if ("number" != typeof n)
				return i = O.sortedIndex(e, t), e[i] === t ? i : -1;
		...
		for (var i = Math.max(Math.ceil((t - e) / n), 0), r = 0, s = new Array(i); i > r; )
			s[r++] = e, e += n;
		return s
	}, O.bind = function(e, t) {
		if (e.bind === A && A)
			return A.apply(e, o.call(arguments, 1));
	...
	var R = function(e, t, n, i) {
		...
		if ("[object Array]" == r) {
			if ( a = e.length, o = a == t.length)
				for (; a-- && ( o = R(e[a], t[a], n, i)); );
		} else {
			var u = e.constructor, l = t.constructor;
			if (u !== l && !(O.isFunction(u) && u instanceof u && O.isFunction(l) && l instanceof l))
				return !1;
			for (var h in e)
			if (O.has(e, h) && (a++, !( o = O.has(t, h) && R(e[h], t[h], n, i))))
				break;
			if (o) {
				for (h in t)
				if (O.has(t, h) && !a--)
	...
	O.mixin(O), S(["pop", "push", "reverse", "shift", "sort", "splice", "unshift"], function(e) {
		...
		O.prototype[e] = function() {
			var n = this._wrapped;
			return t.apply(n, arguments), "shift" != e && "splice" != e || 0 !== n.length ||
			delete n[0], q.call(this, n)
		}
	...
	if ("undefined" != typeof exports && exports._) {
		t._ = exports._.noConflict();
		try {
			t.localStorage = require("localStorage")
		} catch(n) {
			t.localStorage = require("./localStorage.js").localStorage
		}
		t.XMLHttpRequest = require("xmlhttprequest").XMLHttpRequest, exports.AV = t
	} else
		t._ = _.noConflict(), "undefined" != typeof localStorage && (t.localStorage = localStorage), "undefined" != typeof XMLHttpRequest && (t.XMLHttpRequest = XMLHttpRequest);
	"undefined" != typeof $ && (t.$ = $);
	var i = function() {
	}, r = function(e, n, r) {
		var s;
	...
	t.serverURL = "https://cn.avoscloud.com", "undefined" != typeof process && process.versions && process.versions.node && (t._isNode = !0), t.initialize = function(e, n, i) {
		if (i)
			throw "AV.initialize() was passed a Master Key, which is only allowed from within Node.js.";
		t._initialize(e, n, i)
		...
		if (!t.applicationKey && !t.masterKey)
			throw "You must specify a key using AV.initialize";
		if ("batch" !== e && "classes" !== e && "files" !== e && "functions" !== e && "login" !== e && "push" !== e && "search/select" !== e && "requestPasswordReset" !== e && "requestEmailVerify" !== e && "requestPasswordResetBySmsCode" !== e && "resetPasswordBySmsCode" !== e && "requestMobilePhoneVerify" !== e && "requestLoginSmsCode" !== e && "verifyMobilePhone" !== e && "requestSmsCode" !== e && "verifySmsCode" !== e && "users" !== e && "usersByMobilePhone" !== e && "cloudQuery" !== e && "qiniu" !== e && "statuses" !== e && "subscribe/statuses/count" !== e && "subscribe/statuses" !== e && !/users\/[^\/]+\/updatePassword/.test(e) && !/users\/[^\/]+\/friendship\/[^\/]+/.test(e))
			throw "Bad route: '" + e + "'.";
		var a = t.serverURL;
		...
		if ("Pointer" === n.__type) {
			...
			return n.createdAt ? (
			delete n.__type,
			delete n.className, s._finishFetch(n, !0)) : s._finishFetch({
				objectId : n.objectId
			}, !1), s
		}
		if ("Object" === n.__type) {
	...
	t.ACL = function(e) {
		...
		r ? this.permissionsById[i][e] = !0 : (
		delete s[e], n.isEmpty(s) &&
		delete s[i])
		...
		if ( e instanceof t.Role && ( e = e.getName()), n.isString(e))
			return
			void  this.setReadAccess("role:" + e, i);
		throw "role must be a AV.Role or a String"
	}, t.ACL.prototype.setRoleWriteAccess = function(e, i) {
		if ( e instanceof t.Role && ( e = e.getName()), n.isString(e))
			return
			void  this.setWriteAccess("role:" + e, i);
		throw "role must be a AV.Role or a String"
	}
}(this), function(e) {
	e.AV = e.AV || {};
	...
	t.Op = function() {
		...
		return new t.Op.AddUnique(t._decode(
		void 0, e.objects))
		...
		return new t.Op.Remove(t._decode(
		void 0, e.objects))
			...
			var r = this, s = function(e) {
				if ( e instanceof t.Object) {
					...
					if (r._targetClassName || (r._targetClassName = e.className), r._targetClassName !== e.className)
						throw "Tried to create a AV.Relation with 2 different types: " + r._targetClassName + " and " + e.className + ".";
					return e.id
				}
				return e
			};
		...
		return new t.Op.Relation(t._decode(
		void 0, e.objects), [])
	...
	t.Promise = function(e) {
		...
		when : function(e) {
			...
			if (o.length = i.length, u.length = i.length, 0 === s)
				return r ? t.Promise.as.call(this, o) : t.Promise.as.apply(this, o);
			var c = new t.Promise, l = function(e) {
				return s -= 1, a && !c._rejected && r ?
				void  c.reject.call(c, u[e]) :
				void (0 === s && (a && !c._rejected ? c.reject.call(c, u) : r ? c._rejected || c.resolve.call(c, o) : c.resolve.apply(c, o)))
			};
		...
		race : function(e) {
			...
			if (s.length = a.length = n.length, 0 === i)
				return t.Promise.as.call(this);
		...
		then : function(e, n) {
			var i = new t.Promise, r = function() {
				var n = arguments;
				if (e)
					if (t.Promise._isPromisesAPlusCompliant)
						try {
							n = [e.apply(this, n)]
						} catch(r) {
							n = [t.Promise.error(r)]
				...
				if (n) {
					if (t.Promise._isPromisesAPlusCompliant)
						...
						r = [n(e)];
					1 === r.length && t.Promise.is(r[0]) ? r[0].then(function() {
						i.resolve.apply(i, arguments)
					}, function(e) {
						i.reject(e)
					}) : t.Promise._isPromisesAPlusCompliant ? i.resolve.apply(i, r) : i.reject(r[0])
				} else
					i.reject(e)
			}, a = function(e) {
				e.call()
			};
			t.Promise._isPromisesAPlusCompliant && ("undefined" != typeof window && window.setTimeout ? a = function(e) {
				window.setTimeout(e, 0)
			} : "undefined" != typeof process && process.nextTick && ( a = function(e) {
				process.nextTick(e)
			}));
			var o = this;
			return this._resolved ? a(function() {
				r.apply(o, o._result)
			}) : this._rejected ? a(function() {
				s(o._error)
			}) : (this._resolvedCallbacks.push(r), this._rejectedCallbacks.push(s)), i
		},
		"catch" : function(e) {
			return this.then(
			void 0, e)
	...
	var t = e.AV, n = t._, i = function(e) {
		...
		if ("undefined" == typeof FileReader)
			return t.Promise.error(new t.Error(-1, "Attempted to use a FileReader on an unsupported browser."));
		var r = new FileReader;
		return r.onloadend = function() {
			if (2 !== r.readyState)
				return
				void  i.reject(new t.Error(-1, "Error reading file."));
			var e = r.result, s = /^data:([^;]*);base64,(.*)$/.exec(e);
			return s ?
			void  i.resolve(s[2], n || s[1]) :
			void  i.reject(new t.Error(-1, "Unable to interpret data URL: " + e))
		}, r.readAsDataURL(e), i
	};
	t.File = function(e, i, o) {
		...
		this._metaData = {
			owner : null != u ? u.id : "unknown"
		};
		var c = /\.([^.]*)$/.exec(e);
		c && ( c = c[1].toLowerCase());
		var l = o || s[c] || "text/plain";
		if (this._guessedType = l, n.isArray(i))
			this._source = t.Promise.as(r(i), l), this._metaData.size = i.length;
		else if (i && i.base64)
			this._source = t.Promise.as(i.base64, l);
		else if ("undefined" != typeof File && i instanceof File)
			this._source = a(i, o);
		else if (t._isNode && Buffer.isBuffer(i))
			this._source = t.Promise.as(i.toString("base64"), l), this._metaData.size = i.length;
		...
		if (i)
			for (var a in i)
			s._metaData[a] || (s._metaData[a] = i[a]);
		...
		setACL : function(e) {
			...
			void (this._acl = e) : new t.Error(t.Error.OTHER_CAUSE, "ACL must be a AV.ACL.")
		},
		name : function() {
			return this._name
		},
		...
		thumbnailURL : function(e, t, n, i, r) {
			...
			if ( n = n || 100, i = null == i ? !0 : i, 0 >= n || n > 100)
					...
					if (t._isNode) {
						...
						n._previousSave = n._source.then(function(e, i) {
							...
							return i.io.put(r, n._qiniu_key, o, a, function(e) {
								delete n._qiniu_key,
								delete n._base64, e ? (s.reject(e), n.destroy()) : s.resolve(n)
							}), s
						})
					} else
						n._previousSave = n._source.then(function(e, i) {
	...
	t.Object = function(e, i) {
		...
		_mergeMagicFields : function(e) {
			...
			t._arrayEach(r, function(r) {
				e[r] && ("objectId" === r ? i.id = e[r] : i[r] = "createdAt" !== r && "updatedAt" !== r || n.isDate(e[r]) ? e[r] : t._parseDate(e[r]),
				delete e[r])
			})
		},
		_startSave : function() {
		...
		_finishSave : function(e) {
			...
			t._objectEach(e, function(e, n) {
				...
				var r = t._traverse(s._serverData[n], function(e) {
					return e instanceof t.Object && i[e.id] ? i[e.id] :
					void 0
				});
				r && (s._serverData[n] = r)
		...
		_applyOpSet : function(e, n) {
			var i = this;
			t._objectEach(e, function(e, r) {
				n[r] = e._estimate(n[r], i, r), n[r] === t.Op._UNSET &&
				delete n[r]
			})
		},
		...
		_rebuildEstimatedDataForKey : function(e) {
			...
			delete this.attributes[e], this._serverData[e] && (this.attributes[e] = this._serverData[e]), t._arrayEach(this._opSetQueue, function(i) {
				var r = i[e];
				r && (n.attributes[e] = r._estimate(n.attributes[e], n, e), n.attributes[e] === t.Op._UNSET ?
				delete n.attributes[e] : n._resetCacheForKey(e))
			})
		},
		...
		set : function(e, i, r) {
			...
			if (t._objectEach(a, function(e, n) {
					e instanceof t.Op && (a[n] = e._estimate(o.attributes[n], o, n), a[n] === t.Op._UNSET &&
					delete a[n])
				}), !this._validate(s, r))
				return !1;
			...
			return t._arrayEach(n.keys(s), function(e) {
				...
				var a = !0;
				i instanceof t.Op.Set && n.isEqual(o.attributes[e], i.value) && ( a = !1), a && (
				delete u[e], r.silent ? o._silent[e] = !0 : r.changes[e] = !0);
				var c = n.last(o._opSetQueue);
				c[e] = i._mergeWithPrevious(c[e]), o._rebuildEstimatedDataForKey(e), a ? (o.changed[e] = o.attributes[e], r.silent || (o._pending[e] = !0)) : (
				delete o.changed[e],
				delete o._pending[e])
		...
		fetch : function(e) {
			var n = this, i = t._request("classes", this.className, this.id, "GET");
		...
		save : function(e, i, r) {
			...
			d._refreshCache();
			var f = [], p = [];
			return t.Object._findUnsavedChildren(d.attributes, f, p), f.length + p.length > 0 ? t.Object._deepSaveAsync(this.attributes, d).then(function() {
		...
		if (null == e || 0 == e.length)
			return t.Promise.as()._thenRunCallbacks(n);
		...
		if (n.has(t.Object._classMap, e)) {
			...
			i = i || {}, i.className = e, s = this._extend(i, r);
		...
		t._traverse(e, function(e) {
			return e instanceof t.Object ? (e._refreshCache(),
			void (e.dirty() && n.push(e))) : e instanceof t.File ?
			void (e.url() || e.id || i.push(e)) :
			void 0
		})
		...
		return a.then(function() {
			return t.Promise._continueWhile(function() {
				...
				if (t._arrayEach(u, function(t) {
						return e.length > 20 ?
						void  i.push(t) :
						void (t._canBeSerialized() ? e.push(t) : i.push(t))
					}), u = i, 0 === e.length)
				...
				return t._arrayEach(e, function(e) {
					...
					return t._request("batch", null, null, "POST", {
						...
						}), s ? t.Promise.error(new t.Error(s.code, s.error)) :
						void 0
					}).then(function(e) {
	...
	t.User = t.Object.extend("_User", {
		_isCurrentUser : !1,
		_mergeMagicFields : function(e) {
			e.sessionToken && (this._sessionToken = e.sessionToken,
			delete e.sessionToken), t.User.__super__._mergeMagicFields.call(this, e)
		},
		...
		_handleSaveResult : function(e) {
			...
			delete this._serverData.password, this._rebuildEstimatedDataForKey("password"), this._refreshCache(), (e || this.isCurrent()) && t.User._saveCurrentUser(this)
		},
		...
		signUpOrlogInWithMobilePhone : function(e, i) {
			...
			if (!s || "" === s)
				return r = new t.Error(t.Error.OTHER_CAUSE, "Cannot sign up or login user by mobilePhoneNumber with an empty mobilePhoneNumber."), i && i.error && i.error(this, r), t.Promise.error(r);
			var a = e && e.smsCode || this.get("smsCode");
			if (!a || "" === a)
				return r = new t.Error(t.Error.OTHER_CAUSE, "Cannot sign up or login user by mobilePhoneNumber  with an empty smsCode."), i && i.error && i.error(this, r), t.Promise.error(r);
			var o = n.clone(i);
			return o._makeRequest = function(e, n, i, r, s) {
				...
				delete e._serverData.smsCode, i.success && i.success.apply(this, arguments)
			}, this.save(e, o)
		},
		logIn : function(e) {
			...
			return i.then(function(e, t, i) {
				var r = n.parse(e, t, i);
				return n._finishFetch(r), n._handleSaveResult(!0), r.smsCode ||
				delete n.attributes.smsCode, n
			})._thenRunCallbacks(e, this)
		},
		save : function(e, i, r) {
			var s, a;
		...
		requestPasswordReset : function(e, n) {
			var i = {
				email : e
			}, r = t._request("requestPasswordReset", null, null, "POST", i);
			return r._thenRunCallbacks(n)
		},
		requestEmailVerify : function(e, n) {
			var i = {
				email : e
			}, r = t._request("requestEmailVerify", null, null, "POST", i);
			return r._thenRunCallbacks(n)
		},
		...
		requestMobilePhoneVerify : function(e, n) {
			var i = {
				mobilePhoneNumber : e
			}, r = t._request("requestMobilePhoneVerify", null, null, "POST", i);
			return r._thenRunCallbacks(n)
		},
		requestPasswordResetBySmsCode : function(e, n) {
			var i = {
				mobilePhoneNumber : e
			}, r = t._request("requestPasswordResetBySmsCode", null, null, "POST", i);
			return r._thenRunCallbacks(n)
		},
		resetPasswordBySmsCode : function(e, n, i) {
			var r = {
				password : n
			}, s = t._request("resetPasswordBySmsCode", null, e, "PUT", r);
		...
		requestLoginSmsCode : function(e, n) {
			var i = {
				mobilePhoneNumber : e
			}, r = t._request("requestLoginSmsCode", null, null, "POST", i);
			return r._thenRunCallbacks(n)
		},
		current : function() {
			...
			delete n._id, t.User._currentUser._sessionToken = n._sessionToken,
			delete n._sessionToken, t.User._currentUser._finishFetch(n), t.User._currentUser._synchronizeAllAuthData(), t.User._currentUser._refreshCache(), t.User._currentUser._opSetQueue = [{}], t.User._currentUser
		},
	...
	t.Query = function(e) {
		...
		toJSON : function() {
			...
			return this._include.length > 0 && (e.include = this._include.join(",")), this._select && (e.keys = this._select.join(",")), this._limit >= 0 && (e.limit = this._limit), this._skip > 0 && (e.skip = this._skip),
			void 0 !== this._order && (e.order = this._order), t._objectEach(this._extraOptions, function(t, n) {
				e[n] = t
			}), e
		},
		_newObject : function(e) {
			return obj = e && e.className ? new t.Object(e.className) : new this.objectClass, obj
		},
		...
		first : function(e) {
			...
			return r.then(function(e) {
				return n.map(e.results,function(e){var n=t._newObject();return n._finishFetch(t._processResult(e),!0),n})[0]
			})._thenRunCallbacks(e)
		},
		...
		_processResult : function(e) {
			...
			return "Pointer" === t.__type && "_User" === t.className && (
			delete t.__type,
			delete t.className), t
		}
	})
}(this), function(e) {
	e.AV = e.AV || {};
	...
	t.Installation = t.Object.extend("_Installation"), t.Push = t.Push || {}, t.Push.send = function(e, n) {
		if (e.where && (e.where = e.where.toJSON().where), e.where && e.cql)
			throw "Both where and cql can't be set";
		if (e.push_time && (e.push_time = e.push_time.toJSON()), e.expiration_time && (e.expiration_time = e.expiration_time.toJSON()), e.expiration_time && e.expiration_time_interval)
	...
	t.Status = function(e, t) {
		...
		destroy : function(e) {
			if (!this.id)
				return t.Promise.error("The status id is not exists.")._thenRunCallbacks(e);
		...
		send : function(e) {
			...
			if (!this.query)
				return t.Status.sendStatusToFollowers(this, e);
		...
		_finishFetch : function(e) {
			this.id = e.objectId, this.createdAt = t._parseDate(e.createdAt), this.updatedAt = t._parseDate(e.updatedAt), this.messageId = e.messageId,
			delete e.messageId,
			delete e.objectId,
			delete e.createdAt,
			delete e.updatedAt, this.data = t._decode(
			void 0, e)
		}
	...
	t.History.started = !1, n.extend(t.History.prototype, t.Events, {
		...
		start : function(e) {
			...
			return this._wantsHashChange && this._wantsPushState && !this._hasPushState && !c ? (this.fragment = this.getFragment(null, !0), window.location.replace(this.options.root + "#" + this.fragment), !0) : (this._wantsPushState && this._hasPushState && c && u.hash && (this.fragment = this.getHash().replace(i, ""), window.history.replaceState({}, document.title, u.protocol + "//" + u.host + this.options.root + this.fragment)), this.options.silent ?
			void 0 : this.loadUrl())
		},
		stop : function() {
		...
		loadUrl : function(e) {
			var t = this.fragment = this.getFragment(e), i = n.any(this.handlers, function(e) {
				return e.route.test(t) ? (e.callback(t), !0) :
				void 0
			});
			return i
		},
	...
	t.Collection = function(e, t) {
		...
		remove : function(e, t) {
			...
			for ( t = t || {}, e = n.isArray(e) ? e.slice() : [e], i = 0, r = e.length; r > i; i++)
				a = this.getByCid(e[i]) || this.get(e[i]), a && (
				delete this._byId[a.id],
				delete this._byCid[a.cid], s = this.indexOf(a), this.models.splice(s, 1), this.length--, t.silent || (t.index = s, a.trigger("remove", a, this, t)), this._removeReference(a));
			return this
		},
		get : function(e) {
		...
		_removeReference : function(e) {
			this === e.collection &&
			delete e.collection, e.off("all", this._onModelEvent, this)
		},
		_onModelEvent : function(e, t, n, i) {
			("add" !== e && "remove" !== e || n === this) && ("destroy" === e && this.remove(t, i), t && "change:objectId" === e && (
			delete this._byId[t.previous("objectId")], this._byId[t.id] = t), this.trigger.apply(this, arguments))
		}
	});
			...
			if ( e = e || t._getValue(this, "events")) {
				...
				t._objectEach(e, function(t, s) {
					if (n.isFunction(t) || ( t = r[e[s]]), !t)
						throw new Error('Event "' + e[s] + '" does not exist');
